...
<div class="container ">
    ...
    <div class="container mt-2 p-2 m-0" style="background-color:rgb(127, 125, 121)">
                    ...
                    <div class="col-6 p-1">
                        <button type="button" data-read-state="1" class="btn btn-light btn-sm w-100">
                            <img style="width: 1rem;" class="mr-1"
                                 src="https://img3.doubanio.com/f/talion/cf2ab22e9cbc28a2c43de53e39fce7fbc93131d1/pics/card/ic_mark_todo_s.png"/>Want to read
                        </button>
                    </div>
                    <div class="col-6 p-1">
                        <button type="button" data-read-state="2" class="btn btn-light btn-sm  w-100">
                            <img style="width: 1rem;" class="mr-1"
                                 src="https://img3.doubanio.com/f/talion/78fc5f5f93ba22451fd7ab36836006cb9cc476ea/pics/card/ic_mark_done_s.png"/>Already read
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="row" style="background-color: rgba(0,0,0,0.1);">
            ...
            <div class="col-5  pt-2"><h5 class="text-white">${book.evaluationQuantity} reviews</h5></div>
        </div>
    </div>
    <div class="container mt-2 p-2 m-0"><div class=" font-weight-bold alert alert-secondary ">DETAILS</div></div>
    <div class="row p-2 description">
        ${book.description}
    </div>


    <div class="alert alert-primary w-100 mt-2" role="alert">Reviews
...
<div class="modal fade" id="dlgEvaluation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body">
                <h6>Write a review for "${book.bookName}" ...</h6>
                <form id="frmEvaluation">
                    <div class="input-group  mt-2 ">
                        <span id="score"></span>
                    </div>
                    <div class="input-group  mt-2 ">
                        <input type="text" id="content" name="content" class="form-control p-4" placeholder="write your review">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
